...
urlpatterns = [
    ...
    path('<int:pk>/proceedings/<int:proc_pk>/', views.proceeding_type_details,
    ...
    path('<int:pk>/topics/reorder/', views.topics_reorder,
         name='topics-reorder'),
    path('<int:pk>/proceedings/<int:proc_pk>/volumes/new/',
         views.proceeding_volume_create, name='volume-create'),
    path('<int:pk>/proceedings/volumes/<int:vol_pk>/delete/',
